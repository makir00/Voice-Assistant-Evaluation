...
def test_speech_intelligibility(
    tmp_path: Path,
) -> None:
    ...
    recommendation_user = Persona(
        ...
        characteristics=(
            ...
            "using short follow-up questions."
        ),
    )
    ...
    conversational_goldens = [
        ConversationalGolden(
            ...
            expected_outcome=(
                "The assistant responds clearly and audibly "
        ...
        ConversationalGolden(
            ...
            expected_outcome=(
                "The assistant's spoken responses remain clear "
                "and understandable across all turns."
            ),
        ...
        ConversationalGolden(
            ...
            expected_outcome=(
                "The assistant produces intelligible speech "
                "for short and longer spoken responses."
            ),
