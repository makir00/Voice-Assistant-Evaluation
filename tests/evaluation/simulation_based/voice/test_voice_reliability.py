...
def test_voice_reliability(
    ...
    conversational_goldens = [
        ConversationalGolden(
            ...
            expected_outcome=(
                "The assistant responds to every request and delivers "
                "usable audio throughout the conversation."
            ),
        ...
        ConversationalGolden(
            ...
            expected_outcome=(
                "The assistant responds to each user turn and all "
                "spoken responses arrive with usable audio."
            ),
        ...
        ConversationalGolden(
            ...
            expected_outcome=(
                "The assistant reliably responds throughout the "
                "conversation without missing or unusable audio."
            ),
