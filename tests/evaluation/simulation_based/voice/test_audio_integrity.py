...
def test_audio_integrity(
    ...
    conversational_goldens = [
        ConversationalGolden(
            ...
            expected_outcome=(
                "The assistant produces complete and intact audio "
                "for every response."
            ),
        ...
        ConversationalGolden(
            ...
            expected_outcome=(
                "All assistant responses are delivered without "
                "missing, corrupted, looping, or interrupted audio."
            ),
        ...
        ConversationalGolden(
            ...
            expected_outcome=(
                "The assistant's audio remains intact across both "
                "short and longer spoken responses."
            ),
